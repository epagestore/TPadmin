						...
						<tbody>
                           ...
                           <tr>
                             <td style=" width:10px;"><input type="checkbox" value="<?php echo $customer['customer_id']?>" name="supp_id[]" onclick="checkitem($(this),'all')"></td>
							  <td><?php echo $customer['customer_name'] ?><br /><span class="meta"><?php echo $customer['date_added']?></span></td>
                                <td >
								...
								<td class="actions">
									...
									<a class="btn btn-small btn-primary" href="<?php echo base_url();?>index.php/customer/updatecompany/<?php echo $customer['customer_id']?>">Edit</a>
								</td>
							</tr>
