             ...
             <?php echo form_open() ?>
				<div class="span12 ">
                    ...
                    <?php  foreach ($customers as $customer): ?>
                        ...
                        <tr>
                        	<td>Company</td>
                            <td><input type="text" name="company_name"value="<?php echo $customer['company_name']?>" /></td>
                        </tr>
                        <tr>
                        	<td>Company website</td>
                            <td><input type="text" name="company_website"value="<?php echo $customer['company_website']?>" /></td>
                        </tr> 
						<tr>
                        	<td>TP Plan</td>
                            <td><input type="text" name="plan"value="<?php echo $customer['plan']?>" maxlength="5" style="width:50px;" /><span> % </span></td>
                        </tr>
                        <?php }?>
                       <?php  endforeach?>
                    </table>
