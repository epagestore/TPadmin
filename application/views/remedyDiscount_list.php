					...
					<div class="slate">
						...
						<div class="page-header">
							<div class="pull-right listing-buttons">
								<a href="<?php echo base_url();?>index.php/despute/discount_remedy_insert" class="btn btn-success">INSERT</a>
                            ...
                            <tr>
                             <td style=" width:10px;"><input type="checkbox" value="<?php echo $option['reason_id']?>" name="opt_id[]" onclick="checkitem($(this),'all')"></td>
							  <td><a href="form.html"><?php echo $option['description']?></a> <!--<span class="label label-info">Item Status</span>--><br /><span class="meta">Added date</span></td>
								...
								<td class="actions">
									<a class="btn btn-small btn-danger remove-item" data-toggle="removeItem"  href="<?php echo base_url();?>index.php/despute/discount_remedy_delete/<?php echo $option['reason_id']?>">Remove</a>
									<a class="btn btn-small btn-primary" href="<?php echo base_url();?>index.php/despute/discount_remedy_form/<?php echo $option['reason_id']?>">Edit</a>
								</td>
							</tr>
...
function deletemulti($name){
	...
	if(option_id!='')
	{
		$('#removeItem .btn-danger').click(function () {
			window.location.href ="<?php echo base_url();?>index.php/despute/discount_remedy_delete/"+option_id;
		});
